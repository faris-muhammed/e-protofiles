...
var file_cart_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x22, 0xc4, 0x01, 0x0a, 0x08, 0x43, 0x61, 0x72, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x12,
	...
	0x06, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x1b, 0x0a, 0x09,
	0x73, 0x75, 0x62, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x01, 0x52,
	0x08, 0x73, 0x75, 0x62, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x86, 0x01, 0x0a, 0x07, 0x50, 0x72,
...
var file_cart_proto_depIdxs = []int32{
	0,  // 0: cart.RemoveCartResponse.removed_items:type_name -> cart.CartItem
	0,  // 1: cart.ListCartResponse.items:type_name -> cart.CartItem
	1,  // 2: cart.ListProductsResponse.products:type_name -> cart.Product
	10, // 3: cart.CartService.ListProducts:input_type -> cart.ListProductsRequest
	2,  // 4: cart.CartService.AddToCart:input_type -> cart.AddToCartRequest
	4,  // 5: cart.CartService.EditCart:input_type -> cart.EditCartRequest
	6,  // 6: cart.CartService.RemoveCart:input_type -> cart.RemoveCartRequest
	8,  // 7: cart.CartService.ListCart:input_type -> cart.ListCartRequest
	11, // 8: cart.CartService.ListProducts:output_type -> cart.ListProductsResponse
	3,  // 9: cart.CartService.AddToCart:output_type -> cart.AddToCartResponse
	5,  // 10: cart.CartService.EditCart:output_type -> cart.EditCartResponse
	7,  // 11: cart.CartService.RemoveCart:output_type -> cart.RemoveCartResponse
	9,  // 12: cart.CartService.ListCart:output_type -> cart.ListCartResponse
